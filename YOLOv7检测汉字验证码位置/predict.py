...
net = cv.dnn.readNet('menghuan_text.onnx')
...
if __name__ == "__main__":
    pic_path = r'E:\workspace\python\yolov7_menghuan_text\my_dataset\train\images'
    pics = os.listdir(pic_path)
    for pic in pics:
        whole_path = os.path.join(pic_path, pic)
        img = cv.imread(whole_path)
        frame = predict(net, img, yolo_labels, COLORS)
